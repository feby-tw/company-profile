...
const ExploreJob = () => {
  return (
    <div className='bg-red-600 ml-40 mr-40 pt-20 pb-20 text-center tracking-widest rounded-3xl'>
      ...
      <Link href='https://career.eigeradventure.com/jobs' target='_blank' className='inline-flex justify-center items-center rounded-full bg-black text-white p-4 pl-12 pr-12 tracking-widest hover:font-bold'>
